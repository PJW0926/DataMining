...
# 수집 대상 설정
# =====================================
URL = "https://place.map.kakao.com/561633351#review"
...
# 크롤링 동작 설정
# =====================================
MAX_REVIEWS   = 200  # 최대 수집 리뷰 수 (None이면 START_DATE 기준으로 수집)
...
def check_date_range(date_str: str) -> str:
    ...
    if not date_str:
        return "error"
    try:
        # parse_date 결과는 YYYY-M-D 형태이므로 여러 포맷 시도
...
def collect_visible_reviews(driver, collected_dict) -> tuple:
    """
...
def crawl_reviews() -> pd.DataFrame:
    ...
    try:
        ...
        for round_idx in range(1, MAX_ROUNDS + 1):
            ...
            new_count, stop = collect_visible_reviews(driver, collected_dict)
