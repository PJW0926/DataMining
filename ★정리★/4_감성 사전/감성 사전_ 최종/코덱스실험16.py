...
output_file = BASE_DIR / "final_high_trust_reviews_with_sentiment_star_positive_recovery.csv"
platform_output = BASE_DIR / "platform_aspect_sentiment_summary_positive_recovery.csv"
store_output = BASE_DIR / "store_aspect_sentiment_summary_positive_recovery.csv"
review_score_output = BASE_DIR / "review_sentiment_scores_positive_recovery.csv"
compact_output = BASE_DIR / "final_high_trust_reviews_with_sentiment_star_positive_recovery_compact.csv"
review_view_output = BASE_DIR / "final_high_trust_reviews_sentiment_star_positive_recovery_review_view.csv"
error_cases_output = BASE_DIR / "positive_recovery_remaining_diff_abs_over_2_cases.csv"
low_score_high_rating_output = BASE_DIR / "positive_recovery_remaining_high_rating_low_sentiment_cases.csv"
high_score_low_rating_output = BASE_DIR / "positive_recovery_remaining_low_rating_high_sentiment_cases.csv"
overestimation_cases_output = BASE_DIR / "positive_recovery_remaining_low_rating_high_sentiment_cases.csv"
overestimation_diagnosis_output = BASE_DIR / "positive_recovery_remaining_error_diagnosis.csv"
possible_cap_misfire_output = BASE_DIR / "positive_recovery_possible_cap_misfire_high_rating_cases.csv"
possible_floor_misfire_output = BASE_DIR / "positive_recovery_possible_floor_misfire_low_rating_cases.csv"
unmatched_candidate_output = BASE_DIR / "positive_recovery_unmatched_positive_candidate_terms.csv"
error_summary_output = BASE_DIR / "positive_recovery_sentiment_error_summary.csv"
test_results_output = BASE_DIR / "positive_regression_test_results_positive_recovery.csv"
overcap_test_results_output = BASE_DIR / "overestimation_prevention_test_results_positive_recovery.csv"
final_tuning_test_results_output = BASE_DIR / "final_tuning_additional_test_results_positive_recovery.csv"
minimal_tuning_test_results_output = BASE_DIR / "minimal_error_tuning_test_results_positive_recovery.csv"
positive_recovery_test_results_output = BASE_DIR / "positive_evidence_recovery_test_results.csv"
refactor_report_output = BASE_DIR / "sentiment_analysis_positive_evidence_recovery_report.md"
...
if "rating" in df.columns:
    ...
    report_lines = [
        ...
        f"- 평균 절대 오차: {previous_metrics.get('previous_diff_abs_mean', 'N/A')} -> {current_mae}",
        (
            "- `diff_abs > 2`: "
...
for col in original_input_columns:
    ...
    if col == "rating":
        compact_cols.extend([
            candidate
            for candidate in ["sentiment_star", "diff", "diff_abs"]
